...
void print_String(LEDMatrix &mat, const String text, const CRGB color = CRGB(0, 0, 255), const int shift_horizontal = 0, const CRGB background = CRGB(0, 0, 0));

// Überladung von print_String für CHSV Farbe
void print_String(LEDMatrix &mat, const String text, const CHSV color, const int shift_horizontal = 0, const CHSV background = CHSV(0, 0, 0));
